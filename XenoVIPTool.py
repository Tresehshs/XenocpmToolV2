...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '(34): Change Email               3.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(35): Change Password          3.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(36): Custom Spoiler             1.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(37): Custom Body Kit            1.5K'))
            print(colorate.Horizontal(Colors.red_to_yellow, '(38): Unlock Premium Wheels     2K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(39): Unlock Toyota Crown       2.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(40): Unlock Clan Hat (M)       2K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(41): Remove Head Male        1.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(42): Remove Head Female     1.5K'))
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '(46): Unlock Clan Top 1 (FM)    3K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '(47): Unlock Clan Top 2 (FM)    3K'))
            ...
            if service == 0: # Exit
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[?] Enter your new Rainbow Name.'))
                new_name = Prompt.ask("[?] Name")
                console.print("[%] Saving your data: ", end=None)
                if len(new_name) >= 0 and len(new_name) <= 999999999:
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] After deleting your account there is no going back !!.'))
                answ = Prompt.ask("[?] Do You want to Delete this Account ?!", choices=["y", "n"], default="n")
                if answ == "y":
                    cpm.delete()
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, '======================================'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, f'Thank You for using our tool, please join our telegram channe: @{__CHANNEL_USERNAME__}.'))
                else: continue
            elif service == 9: # Account Register
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Registring new Account.'))
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, '======================================'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, f'INFO: In order to tweak this account with CPMXeno.'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'you most sign-in to the game using this account.'))
                    sleep(2)
                    continue
                elif status == 105:
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'This email is already exists !.'))
                    sleep(2)
                    continue
                else:
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'FAILED.'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Insert how much races you win.'))
                amount = IntPrompt.ask("[?] Amount")
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Insert how much races you lose.'))
                amount = IntPrompt.ask("[?] Amount")
                console.print("[%] Changing your data: ", end=None)
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Please Enter Account Detalis.'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] ENTER STEERING ANGLE'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] ENTER CAR DETALIS'))
                car_id = IntPrompt.ask("[bold][?] CAR ID[/bold]")
                print(Colorate.Horizontal(Colors.red_to_yellow, "[!]ENTER NEW BRAKE!"))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Setting Percentage'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] ENTER CAR DETALIS'))
                car_id = IntPrompt.ask("[bold][?] CAR ID[/bold]")                
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Removing Rear Bumper'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] ENTER CAR DETALIS'))
                car_id = IntPrompt.ask("[bold][?] CAR ID[/bold]")                
                print(Colorate.Horizontal(Colors.red_to_yellow, '[!] Removing front Bumper'))
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[%] UNLOCKING CLAN CLOTHES TOP 2'))
                if cpm.unlock_topmx():
                    print(Colorate.Horizontal(Colors.green_to_white, 'SUCCESSFUL (✔)'))
                    print(Colorate.Horizontal(Colors.green_to_white, '======================================'))
                    answ = Prompt.ask("[bold][?] DO YOU WANT TO EXIT[/bold]?", choices=["y", "n"], default="n")
                ...
                print(Colorate.Horizontal(Colors.red_to_yellow, '[%] UNLOCKING CLAN CLOTHES TOP'))
                if cpm.unlock_topf():
                    print(Colorate.Horizontal(Colors.green_to_white, 'SUCCESSFUL (✔)'))
                    print(Colorate.Horizontal(Colors.green_to_white, '======================================'))
                    answ = Prompt.ask("[bold][?] DO YOU WANT TO EXIT[/bold]?", choices=["y", "n"], default="n")
